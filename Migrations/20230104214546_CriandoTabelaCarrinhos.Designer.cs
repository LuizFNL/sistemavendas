...
namespace sistemavendas.Migrations
{
    ...
    [Migration("20230104214546_CriandoTabelaCarrinhos")]
    partial class CriandoTabelaCarrinhos
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("sistemavendas.Models.ItensModel", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("ItensModel");
            ...
            modelBuilder.Entity("sistemavendas.Models.CarrinhoModel", b =>
                {
                    b.HasBaseType("sistemavendas.Models.ItensModel");

                    b.Property<int>("NomeId")
                        .HasColumnType("int");

                    b.HasDiscriminator().HasValue("CarrinhoModel");
                });
